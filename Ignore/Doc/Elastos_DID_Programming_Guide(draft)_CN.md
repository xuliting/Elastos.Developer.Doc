# Elastos DID Programming Guide（draft）
...
Elastos DID Side-Chain提供了DID的创建、读和写接口，请参考《Elastos_DID_Spec(draft)_CN.md》。
...
证明内容的设计要充分考虑：内容是否存证二义性、是否存在被冒用或者挪用的可能性。
...
![image](../images/DID_Programming_4.png)
